...
- **UI**: tabs, recursive pane tree (Cmd-D / Cmd-Shift-D), bottom tab strip, dotted dividers, mouse selection with copy-on-mouseup, Cmd-V paste, Cmd-N multi-window, Cmd-Opt-arrows directional pane focus, Shift-PageUp/Down scrollback.
...
| Cmd-W | close pane (collapses split) or last-pane tab |
...
| Shift-PageUp/Down, Shift-Up/Down | scroll history |
